...
const CONFIG = {
  ...
  sprints: [
    ...
    { id: "Sprint 5", title: "User Accounts & Session Persistence", goal: "PostgreSQL-only migration, codebase refactoring (orchestrator/grader/repository seams, AI_BACKEND env), Flask-Login + SQLAlchemy auth integration, sign-up/sign-in/logout, learner dashboard, max 3 lessons gating, admin access control, Bob/Alice demo accounts.", status: "In Progress" },
  ...
  userStories: [
    ...
    { id: "US-027", title: "As a learner, I want to create an account, sign in, and sign out so my progress is saved.", sprint: "Sprint 5", status: "In Progress", tasks: [["Purge all SQLite references; lock PostgreSQL-only", ["Backend", "Infra"]], ["Extract lesson orchestrator, grader, and session repository seam", ["Backend", "Refactor"]], ["Fix ai_client.py indirection (env AI_BACKEND) and add happy-path smoke test", ["AI", "Refactor"]], ["Integrate Flask-Login, Flask-SQLAlchemy, PostgreSQL only", ["Backend", "Auth"]], ["Build sign-up, sign-in, logout routes and templates", ["Backend", "Auth"]], ["Store user credentials securely (hashed passwords)", ["Backend", "Security"]], ["Write unit and integration tests for auth flow", ["Testing", "Auth"]]] },
...
const SNAPSHOTS = [
  { date: "2026-05-16", isCurrent: true, data: null },
