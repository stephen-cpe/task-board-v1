...
const CONFIG = {
  ...
  sprints: [
    ...
    { id: "Sprint 5", title: "User Accounts & Session Persistence", goal: "Flask-Login + PostgreSQL, sign-up/sign-in, learner dashboard, max 3 lessons gating, admin access control, Bob/Alice demo accounts.", status: "In Progress" },
...
const SNAPSHOTS = [
  { date: "2026-05-15", isCurrent: true, data: null },
