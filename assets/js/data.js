...
const CONFIG = {
  ...
  userStories: [
    ...
    { id: "US-038", title: "As a learner, I want to export completed lessons to PDF.", sprint: "Sprint 7", status: "Done", tasks: [["Generate PDF from lesson slides and quiz results", ["Backend", "Feature"]], ["Add PDF export button on completed lesson page", ["Frontend", "UX"]]] },
    { id: "US-041", title: "As a learner, I want lessons to reference their source documents.", sprint: "Sprint 7", status: "Done", tasks: [["Link generated lesson content back to source PDF/document", ["Backend", "Feature"]], ["Add citations showing which document a slide references", ["Frontend", "UX"]]] },
    { id: "US-046", title: "As a learner, I want a difficulty selector so content matches my age and skill level.", sprint: "Sprint 7", status: "In Progress", tasks: [["Add Easy (10–11) / Moderate (12–13) / Hard (14–15) difficulty selector on upload form", ["Frontend", "Feature"]], ["Inject difficulty into lesson and quiz generation prompts", ["Backend", "AI"]], ["Verify age-appropriate output differences in generated lessons", ["Testing", "Quality"]]] },
    ...
    { id: "US-022", title: "As a learner, I want a difficulty toggle so content matches my age and skill level. (Promoted from post-capstone to Sprint 7 — core differentiator for 10–15 age target)", sprint: "Sprint 7", status: "In Progress", tasks: [["Add Easy / Moderate / Hard dropdown on upload form", ["Frontend", "Feature"]], ["Inject difficulty into AI prompts per module", ["Backend", "AI"]]] },
  ...
  scopeLadder: [
    ["Implemented (Sprints 1–7+)", ["RAG pipeline and chunking (Proprietary Knowledge Grounding)", "AI summary and relevance checks", "Interactive slide deck engine (custom CSS/JS)", "Mixed-type quizzes and grading (4 question types)", "Gated progression logic (80% mastery threshold)", "CI/CD and 202 automated tests", "Retro cyberpunk theme with pixel fonts", "Static mascot with progress-aware speech bubble", "Non-blocking AJAX process route with stage tracking", "One-word fill-in-the-blank with per-blank grading", "PostgreSQL-only migration and refactoring", "Flask-Login auth: sign-up, login, logout", "Learner dashboard with Active/Completed/Cancelled tabs", "Max 3 active lessons gating", "Admin access control and demo account seeding", "Admin panel, password reset, error handlers", "Multi-path lesson support and DB-first retrieval", "AI-powered OCR/vision (GLM-OCR + Qwen3.5)", "Content-addressable global deduplication", "Content-keyed multi-collection ChromaDB", "Extended file types (.docx, .pptx, .png, .jpg, .jpeg)", "9-stage progress tracking with OCR stages", "Typed exception hierarchy (AIServiceError)", "Route blueprint split (auth/admin/processing/lessons/dashboard)", "JS split into domain modules (mascot/progress/upload/deck-engine/deck-page/results)", "CSS split into deck-base + deck-components", "Relevance gating (weak blocks study path + lessons; partial warnings)", "Source document citations (View Sources modal in slide deck)", "Dashboard tabs (Active/Completed/Cancelled + Mark Complete + Delete)", "Per-lesson PDF export via fpdf2 (slides, quiz, checkpoints, sources)"]],
    ["Sprint 7 — In Progress", ["Mascot animation frames (idle/busy/happy) — DONE", "PDF export for completed lessons — DONE", "Source-cited lesson slides — DONE", "Dashboard history tabs and lifecycle — DONE", "Sample demo document set (creation)", "Difficulty/age-level selector (Easy/Moderate/Hard)", "Text-to-speech narration (opt-in)", "Session cleanup (extracted_texts removal)", "Badge/trophy system for completed modules (stretch)", "Cloud ChromaDB and cloud AI provider testing", "General refinement and test expansion"]],
...
const SNAPSHOTS = [
  { date: "2026-06-09", isCurrent: true, data: null },
  { date: "2026-06-08", isCurrent: false, data: {
  ...
  userStories: [
    ...
    { id: "US-045", title: "As a developer, I want final bug fixes and capstone submission ready.", sprint: "Sprint 8", status: "Backlog", tasks: [["Triage and fix remaining production bugs", ["Backend", "Maintenance"]], ["Run full CI pipeline one final time", ["Testing", "CI/CD"]], ["Submit capstone project", ["Process", "Capstone"]]] },
    { id: "US-022", title: "As a learner, I want a difficulty toggle so content matches my age and skill level. (Deferred to post-capstone — high effort, low impact for MVP.)", sprint: "Post-Capstone", status: "Backlog", tasks: [["Add Easy (10–11) / Moderate (12–13) / Hard (14–15) difficulty selector", ["Frontend", "Feature"]], ["Adjust lesson and quiz prompts based on selected difficulty", ["Backend", "AI"]]] }
  ],
  scopeLadder: [
