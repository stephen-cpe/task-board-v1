...
const CONFIG = {
  ...
  userStories: [
    ...
    { id: "US-033", title: "As a learner, I want text-to-speech so I can listen to lesson content.", sprint: "Sprint 6", status: "In Progress", tasks: [["Integrate Web Speech API or TTS library", ["Frontend", "Feature"]], ["TTS disabled by default, can be enabled in settings", ["Frontend", "UX"]], ["Add TTS toggle button on slide deck", ["Frontend", "Feature"]]] },
    { id: "US-034", title: "As a learner, I want to export completed lessons to PDF.", sprint: "Sprint 6", status: "In Progress", tasks: [["Generate PDF from lesson slides and quiz results", ["Backend", "Feature"]], ["Add export button on completed lesson page", ["Frontend", "UX"]], ["Test PDF output for correctness", ["Testing", "Unit"]]] },
