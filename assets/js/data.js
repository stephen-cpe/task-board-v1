...
*/
// Current active board state (May 9, 2026)
const CONFIG = {
...
{ id: "sprint-2", name: "Sprint 2", title: "RAG Pipeline & AI Processing", goal: "Implement LangChain chunking, ChromaDB vector storage, multi-upload (≤5), parsers, and summary service with mocked fallback.", status: "Done" },
{ id: "sprint-3", name: "Sprint 3", title: "Relevance, Study Path & UI Polish", goal: "Complete AI relevance checking, curriculum generation, guided workflow UI, and end-to-end integration tests.", status: "In Progress" },
{ id: "sprint-4", name: "Sprint 4", title: "Deployment & Demo Prep", goal: "Deploy to free-tier host, finalize documentation, prepare demo script, record 15–20 min presentation.", status: "Ready" }
],
userStories: [
...
const SNAPSHOTS = [
{ date: "2026-05-09", isCurrent: true, data: null },
