...
const CONFIG = {
  ...
  sprints: [
    ...
    { id: "Sprint 4", title: "UX Polish & QA Stabilization", goal: "Fix fill-in-the-blank, mascot positioning, loading feedback, prompt tuning.", status: "In Progress" },
  ...
  userStories: [
    ...
    { id: "US-027", title: "As a learner, I want to create an account, sign in, and sign out so my progress is saved.", sprint: "Sprint 5", status: "Backlog", tasks: [["Integrate Flask-Login + PostgreSQL (SQLite for demo)", ["Backend", "Auth"]], ["Build sign-up, sign-in, logout routes and templates", ["Backend", "Auth"]], ["Store hashed passwords and session persistence", ["Backend", "Security"]]] },
    { id: "US-028", title: "As a learner, I want a dashboard to see my active lessons and progress.", sprint: "Sprint 5", status: "Backlog", tasks: [["Build main dashboard with lesson list and completion status", ["Frontend", "Dashboard"]], ["Show mascot on dashboard as visual placeholder", ["Frontend", "Mascot"]], ["Track completed vs abandoned/cancelled lessons", ["Backend", "Logic"]]] },
    { id: "US-029", title: "As a learner, I can have max 3 active lessons at a time to encourage focus.", sprint: "Sprint 5", status: "Backlog", tasks: [["Enforce max 3 active lessons per user", ["Backend", "Logic"]], ["Require abandon/cancel before creating a new lesson", ["Backend", "Logic"]], ["Show warning when limit reached", ["Frontend", "UX"]]] },
    { id: "US-030", title: "As an admin, I want to control which users can generate lessons.", sprint: "Sprint 5", status: "Backlog", tasks: [["Create super admin role with per-user access toggle", ["Backend", "Auth"]], ["Deny lesson generation by default for new registrations", ["Backend", "Security"]], ["Landing page shows: 'You don't have access' for unauthorized users", ["Frontend", "UX"]]] },
    { id: "US-031", title: "As a reviewer, I want demo accounts (Bob, Alice) with access to generate lessons.", sprint: "Sprint 5", status: "Backlog", tasks: [["Seed Bob and Alice accounts with lesson generation access", ["Backend", "Demo"]], ["Allow public registration but auto-deny lesson access", ["Backend", "Auth"]], ["Test the full sign-up to lesson workflow", ["Testing", "Integration"]]] },

    // ── Epic 8: Polish & Maintenance (Sprint 6) ──
    { id: "US-032", title: "As a learner, I want a polished dashboard with mascot feedback.", sprint: "Sprint 6", status: "Backlog", tasks: [["Polish dashboard UI with mascot placeholder", ["Frontend", "Dashboard"]], ["Add mascot basic animation frames (idle/waiting/done)", ["Frontend", "Mascot"]], ["Display mascot state changes during loading operations", ["Frontend", "UX"]]] },
    ...
    { id: "US-035", title: "As a developer, I want to clean up session bloat and fix accumulated bugs.", sprint: "Sprint 6", status: "Backlog", tasks: [["Remove extracted_texts from session after lessons generated", ["Backend", "Performance"]], ["Fix bugs discovered during Sprint 5 testing", ["Backend", "Maintenance"]], ["Run full test suite and ensure 45+ tests pass", ["Testing", "CI/CD"]]] },

    // ── Epic 9: OCR & Advanced Features (Sprint 7) ──
    { id: "US-036", title: "As a learner, I want scanned PDFs to be understood via OCR.", sprint: "Sprint 7", status: "Backlog", tasks: [["Integrate OCR engine (Tesseract or similar)", ["Backend", "OCR"]], ["Detect images in uploaded documents and run OCR analysis", ["Backend", "OCR"]], ["Feed OCR output into chunking pipeline after extraction", ["Backend", "RAG"]], ["Write tests for OCR integration", ["Testing", "Integration"]]] },
    ...
    { id: "US-038", title: "As a learner, I want lessons to reference their source documents.", sprint: "Sprint 7", status: "Backlog", tasks: [["Link generated lesson content back to source PDF/document", ["Backend", "Feature"]], ["Add citations or tooltips showing which document a slide references", ["Frontend", "UX"]], ["Test source linking accuracy", ["Testing", "Integration"]]] },

    // ── Epic 10: Final Deployment & Demo (Sprint 8) ──
    { id: "US-040", title: "As a developer, I want to deploy the app to a free-tier host.", sprint: "Sprint 8", status: "Backlog", tasks: [["Deploy to Render or Railway free tier", ["DevOps", "Deployment"]], ["Configure environment variables for production", ["DevOps", "Security"]], ["Verify all routes and features work in production", ["Testing", "Integration"]]] },
    { id: "US-041", title: "As a reviewer, I want complete project documentation.", sprint: "Sprint 8", status: "Backlog", tasks: [["Finalize README, SRS, DESIGN_AND_TESTING docs", ["Docs", "Evidence"]], ["Update task board to reflect final sprint status", ["Docs", "Evidence"]], ["Ensure AI_AGENT_PROTOCOL.md is current", ["Docs", "Evidence"]]] },
    { id: "US-042", title: "As a reviewer, I want a 15-minute demo video showing the full workflow.", sprint: "Sprint 8", status: "Backlog", tasks: [["Write demo script covering all user stories", ["Docs", "Demo"]], ["Record 15-minute walkthrough of the app", ["Docs", "Demo"]], ["Add demo link to README", ["Docs", "Evidence"]]] },
    { id: "US-043", title: "As a developer, I want final bug fixes and capstone submission ready.", sprint: "Sprint 8", status: "Backlog", tasks: [["Triage and fix any remaining production bugs", ["Backend", "Maintenance"]], ["Run full CI pipeline one final time", ["Testing", "CI/CD"]], ["Submit capstone project", ["Process", "Capstone"]]] }
  ],
  scopeLadder: [
...
const SNAPSHOTS = [
  { date: "2026-05-14", isCurrent: true, data: null },
